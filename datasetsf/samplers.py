...
#             每轮生成一次，id_list存放本轮的查询集和支持集样本id
...
# loader1 = torch.utils.data.DataLoader(
        ...
        # num_workers = 3,
        # pin_memory = False)
# 这个代码的执行实际上只调用了random_sampler的init函数，iter函数是在受到对loader1使用迭代操作时候执行的  ，如果不是运气好，迭代想输出，还真不知道          
            
class CLIP_sampler(Sampler):
